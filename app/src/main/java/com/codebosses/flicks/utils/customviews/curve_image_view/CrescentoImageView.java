package com.codebosses.flicks.utils.customviews.curve_image_view;
...
public class CrescentoImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (styledAttributes.hasValue(R.styleable.CrescentoImageView_tintModes)) {
            if (styledAttributes.getInt(R.styleable.CrescentoImageView_tintModes, 0) == TintMode.AUTOMATIC) {
